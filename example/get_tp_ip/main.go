...
import (
	...
	"github.com/cen-ngc5139/BeePF/example/get_tp_ip/binary"
...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target $TARGET_GOARCH -go-package binary -output-dir ./binary -cc clang -no-strip GetTpIp ./bpf/bpf.c -- -I../headers -Wno-address-of-packed-member
